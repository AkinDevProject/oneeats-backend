    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Paramètres Restaurant</h1>
            <p className="text-gray-600 mt-1">Configurez votre profil restaurant</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
        ...
        <div className="mb-6 lg:mb-8">
          <Card className={`p-4 sm:p-6 max-w-sm ${isOpen ? 'bg-gradient-to-br from-green-500 to-green-600' : 'bg-gradient-to-br from-red-500 to-red-600'} text-white shadow-lg`}>
