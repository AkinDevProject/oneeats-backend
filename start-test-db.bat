...
REM Arrêter le conteneur de test s'il existe déjà
docker stop oneeats-postgres-test 2>nul
docker rm oneeats-postgres-test 2>nul

REM Démarrer seulement le service postgres-test
