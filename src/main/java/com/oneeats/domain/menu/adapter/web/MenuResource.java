package com.oneeats.domain.menu.adapter.web;

import com.oneeats.domain.menu.api.cqrs.command.CreateMenuItemCommand;
import com.oneeats.domain.menu.api.cqrs.command.UpdateMenuItemCommand;
import com.oneeats.domain.menu.api.model.MenuItemDto;
import com.oneeats.domain.menu.internal.application.CreateMenuItemUseCase;
import com.oneeats.domain.menu.internal.application.UpdateMenuItemUseCase;
import com.oneeats.domain.menu.internal.application.GetMenuItemUseCase;
import com.oneeats.domain.menu.internal.application.GetAllMenuItemsUseCase;
import com.oneeats.domain.menu.internal.application.DeleteMenuItemUseCase;
