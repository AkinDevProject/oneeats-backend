package com.oneeats.domain.order.adapter.web;

import com.oneeats.domain.order.api.cqrs.command.CreateOrderCommand;
import com.oneeats.domain.order.api.cqrs.command.UpdateOrderCommand;
import com.oneeats.domain.order.api.model.OrderDto;
import com.oneeats.domain.order.internal.application.CreateOrderUseCase;
import com.oneeats.domain.order.internal.application.UpdateOrderUseCase;
import com.oneeats.domain.order.internal.application.GetOrderUseCase;
import com.oneeats.domain.order.internal.application.GetAllOrdersUseCase;
import com.oneeats.domain.order.internal.application.DeleteOrderUseCase;
