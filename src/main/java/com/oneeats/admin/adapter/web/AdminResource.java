package com.oneeats.admin.adapter.web;

import com.oneeats.admin.api.cqrs.command.CreateAdminCommand;
import com.oneeats.admin.api.cqrs.command.UpdateAdminCommand;
import com.oneeats.admin.api.model.AdminDto;
import com.oneeats.admin.internal.application.CreateAdminUseCase;
import com.oneeats.admin.internal.application.UpdateAdminUseCase;
import com.oneeats.admin.internal.application.GetAdminUseCase;
import com.oneeats.admin.internal.application.GetAllAdminsUseCase;
import com.oneeats.admin.internal.application.DeleteAdminUseCase;
